...
from .views import (
    ...
    ClassSessionOutcomeView, ClassSessionMeetLinkView, AdminClassSessionsListView,
...
urlpatterns = [
    ...
    path('admin/sessions/', AdminClassSessionsListView.as_view(), name='admin-class-sessions-list'),
